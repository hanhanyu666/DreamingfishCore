...
import com.mo.dreamingfishcore.core.storybook_system.FragmentData;
...
public class Item_FragmentPage extends Item {
    ...
    public static void setFragmentId(ItemStack stack, int fragmentId) {
        CompoundTag rootTag = com.mo.dreamingfishcore.utils.ItemStackDataHelper.getTag(stack);
        if (rootTag == null) {
        ...
        com.mo.dreamingfishcore.utils.ItemStackDataHelper.setTag(stack, rootTag);
    }

    public static Integer getFragmentId(ItemStack stack) {
        if (!com.mo.dreamingfishcore.utils.ItemStackDataHelper.hasTag(stack)) {
            return null;
        }
