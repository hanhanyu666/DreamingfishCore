package com.mo.dreamingfishcore.network;

import com.mo.dreamingfishcore.network.packets.Packet_OnlinePlayerCountRequest;
import com.mo.dreamingfishcore.network.packets.Packet_OnlinePlayerCountResponse;
import com.mo.dreamingfishcore.network.packets.Packet_ServerPlayerListRequest;
import com.mo.dreamingfishcore.network.packets.Packet_ServerPlayerListResponse;
import com.mo.dreamingfishcore.network.packets.Packet_SystemMessage;
import com.mo.dreamingfishcore.network.packets.check_system.Packet_Check;
import com.mo.dreamingfishcore.network.packets.check_system.Packet_CheckResultRequest;
import com.mo.dreamingfishcore.network.packets.check_system.Packet_CheckResultResponse;
import com.mo.dreamingfishcore.network.packets.check_system.Packet_Chunk;
import com.mo.dreamingfishcore.network.packets.check_system.Packet_ChunkResponse;
import com.mo.dreamingfishcore.network.packets.check_system.Packet_Get;
import com.mo.dreamingfishcore.network.packets.check_system.Packet_GetResultRequest;
import com.mo.dreamingfishcore.network.packets.check_system.Packet_GetResultResponse;
import com.mo.dreamingfishcore.network.packets.login_system.Packet_PlayerLoginRequest;
import com.mo.dreamingfishcore.network.packets.login_system.Packet_PlayerLoginResponse;
import com.mo.dreamingfishcore.network.packets.login_system.Packet_PlayerLoginResult;
import com.mo.dreamingfishcore.network.packets.notice_system.Packet_MarkNoticeReadRequest;
import com.mo.dreamingfishcore.network.packets.notice_system.Packet_NoticeCheckResponse;
import com.mo.dreamingfishcore.network.packets.notice_system.Packet_NoticeListRequest;
import com.mo.dreamingfishcore.network.packets.notice_system.Packet_NoticeListResponse;
import com.mo.dreamingfishcore.network.packets.npc_system.Packet_NpcInteractionRequest;
import com.mo.dreamingfishcore.network.packets.npc_system.Packet_OpenNpcDialogueGUI;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.courage_system.Packet_SyncCourageData;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.death_system.Packet_DeathScreenData;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.death_system.Packet_KeepInventoryRequest;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.death_system.Packet_KeepInventoryResponse;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.death_system.Packet_NormalRespawnRequest;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.death_system.Packet_NormalRespawnResponse;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.death_system.Packet_OpenRevivalCharmGUI;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.death_system.Packet_RevivalRequest;
...
import com.mo.dreamingfishcore.network.packets.playerattribute_system.strength_system.Packet_CantRun;
import com.mo.dreamingfishcore.network.packets.playerattribute_system.strength_system.Packet_SyncStrengthData;
import com.mo.dreamingfishcore.network.packets.playerdata_system.Packet_LevelUpNotify;
import com.mo.dreamingfishcore.network.packets.playerdata_system.Packet_RequestAllPlayerData;
import com.mo.dreamingfishcore.network.packets.playerdata_system.Packet_RequestPlayerStats;
import com.mo.dreamingfishcore.network.packets.playerdata_system.Packet_SyncPlayerData;
import com.mo.dreamingfishcore.network.packets.playerdata_system.Packet_SyncPlayerStats;
import com.mo.dreamingfishcore.network.packets.playerdata_system.Packet_VanillaAdvancementNotify;
import com.mo.dreamingfishcore.network.packets.storybook_system.Packet_OpenStoryBookGUI;
import com.mo.dreamingfishcore.network.packets.storybook_system.Packet_OpenStoryFragmentGUI;
import com.mo.dreamingfishcore.network.packets.storybook_system.Packet_UpdateStoryBookOrder;
import com.mo.dreamingfishcore.network.packets.task_system.Packet_SyncCompleteTask;
import com.mo.dreamingfishcore.network.packets.task_system.Packet_SyncFullTaskData;
import com.mo.dreamingfishcore.network.packets.task_system.Packet_SyncUpdateTask;
import com.mo.dreamingfishcore.network.packets.tip_system.Packet_SendTipToClient;
