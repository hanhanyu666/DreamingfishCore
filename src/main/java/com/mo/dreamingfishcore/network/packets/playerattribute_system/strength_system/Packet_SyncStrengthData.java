package com.mo.dreamingfishcore.network.packets.playerattribute_system.strength_system;

import com.mo.dreamingfishcore.core.playerattributes_system.strength.PlayerStrengthClientSync;
import com.mo.dreamingfishcore.core.playerattributes_system.strength.PlayerStrengthManager;
...
public class Packet_SyncStrengthData implements net.minecraft.network.protocol.common.custom.CustomPacketPayload {
    ...
    public static final net.minecraft.network.protocol.common.custom.CustomPacketPayload.Type<Packet_SyncStrengthData> TYPE = new net.minecraft.network.protocol.common.custom.CustomPacketPayload.Type<>(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(com.mo.dreamingfishcore.EconomySystem.MODID, "playerattribute_system/strength_system/packet_sync_strength_data"));
