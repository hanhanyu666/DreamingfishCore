...
import com.mo.dreamingfishcore.core.playerattributes_system.death.Screen_RevivalCharm;
...
public class Packet_OpenRevivalCharmGUI implements net.minecraft.network.protocol.common.custom.CustomPacketPayload {
    ...
    public static final net.minecraft.network.protocol.common.custom.CustomPacketPayload.Type<Packet_OpenRevivalCharmGUI> TYPE = new net.minecraft.network.protocol.common.custom.CustomPacketPayload.Type<>(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(com.mo.dreamingfishcore.EconomySystem.MODID, "playerattribute_system/death_system/packet_open_revival_charm_gui"));
