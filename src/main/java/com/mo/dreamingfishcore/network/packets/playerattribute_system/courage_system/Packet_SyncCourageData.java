package com.mo.dreamingfishcore.network.packets.playerattribute_system.courage_system;
...
public class Packet_SyncCourageData implements net.minecraft.network.protocol.common.custom.CustomPacketPayload {
    ...
    public static final net.minecraft.network.protocol.common.custom.CustomPacketPayload.Type<Packet_SyncCourageData> TYPE = new net.minecraft.network.protocol.common.custom.CustomPacketPayload.Type<>(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(com.mo.dreamingfishcore.EconomySystem.MODID, "playerattribute_system/courage_system/packet_sync_courage_data"));
