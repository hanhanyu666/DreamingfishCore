...
public class Packet_PlayerLoginRequest implements net.minecraft.network.protocol.common.custom.CustomPacketPayload {
    ...
    private static void handleClient(Packet_PlayerLoginRequest msg) {
        ...
        com.mo.dreamingfishcore.EconomySystem.LOGGER.info("客户端收到登录请求包，loginOrRegister={}, requireRegistration={}", msg.isLoginOrRegister(), requireRegistration);
        minecraft.setScreen(new com.mo.dreamingfishcore.core.login_system.Screen_LoginUI(requireRegistration));
    }
}
