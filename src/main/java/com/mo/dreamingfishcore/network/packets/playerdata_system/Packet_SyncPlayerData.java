...
import com.mo.dreamingfishcore.server.chattitle.PlayerTitleManager;
import com.mo.dreamingfishcore.server.chattitle.Title;
import com.mo.dreamingfishcore.server.chattitle.TitleRegistry;
    ...
    private static void syncPlayerDataOnClient(UUID playerUUID, String playerName, boolean isOnline, String rankName, String titleName,
        ...
        try {
            ...
            */
            ...
            PlayerData cachedData = com.mo.dreamingfishcore.client.cache.ClientCacheManager.getOrCreatePlayerData(playerUUID);
            ...
            com.mo.dreamingfishcore.client.cache.ClientCacheManager.setPlayerData(playerUUID, cachedData);
