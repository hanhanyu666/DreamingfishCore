...
public class Packet_DeathScreenData implements net.minecraft.network.protocol.common.custom.CustomPacketPayload {
    ...
    public static final net.minecraft.network.protocol.common.custom.CustomPacketPayload.Type<Packet_DeathScreenData> TYPE = new net.minecraft.network.protocol.common.custom.CustomPacketPayload.Type<>(net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(com.mo.dreamingfishcore.EconomySystem.MODID, "playerattribute_system/death_system/packet_death_screen_data"));
    ...
    private static class ClientHandler {
        static void handle(Packet_DeathScreenData packet) {
            ...
            com.mo.dreamingfishcore.core.playerattributes_system.death.DeathScreenDataStorage.setData(
                packet.respawnPoint,
                packet.normalCost,
